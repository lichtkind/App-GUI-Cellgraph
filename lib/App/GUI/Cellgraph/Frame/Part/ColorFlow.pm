...
package App::GUI::Cellgraph::Frame::Part::ColorFlow;
...
sub new {
    ...
    $self->{'stepsize'}  = App::GUI::Cellgraph::Widget::SliderCombo->new( $self,  94, 'Step Size','after how many circles does color change', 1, 100, 1);
    $self->{'period'}    = App::GUI::Cellgraph::Widget::SliderCombo->new( $self, 100, 'Period','amount of steps from start to end color', 2, 50, 10);
